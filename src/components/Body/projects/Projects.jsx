  ...
  return (
      <div className='flex justify-center'>
        <div className='grid place-items-center md:grid-cols-2 xl:grid-cols-3 w-1/8 gap-7'>
            <BaseCard type='Web' name='Tesla Clone' backgroundImage={Teslaclone} code='https://github.com/jackonshiundu/tesla-clone-reactjs-styledcomponents-' arrowhover='bg-blue-300' bgcolor='bg-blue-300' link='https://tesla-clone-reactjs-styledcomponents.vercel.app'/>
            <BaseCard type='Web' name='Portfolio Website' backgroundImage={sambaportfolio} code='https://github.com/jackonshiundu/portfoliowebsite-html5-sass-css-javascript' bgcolor='bg-purple-300'  link='https://portfoliowebsite-html5-sass-css-javascript.vercel.app'/>
            <BaseCard type='Web' name='Data Analytics Website' backgroundImage={dataanalytics} code='https://github.com/jackonshiundu/datacompanylandingpagewebsite-reactjs-tailwindcss' bgcolor='bg-white' link='https://datacompanylandingpagewebsite-reactjs-tailwindcss.vercel.app'/>
